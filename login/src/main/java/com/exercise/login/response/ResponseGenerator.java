package com.exercise.login.response;
...
import com.exercise.login.response.Data;
import com.exercise.login.response.Error;
import com.exercise.login.response.Response;
